'''
Project: pytest for BST project
Author: Frank Jones, based on work by George Rudolph
Course:  CS 2420 Fall 2022
Date: 5 Nov 2022
...
To run:
You must have pytest module installed.
You must have the student's bst.py, student's copy of test_bst.py and
